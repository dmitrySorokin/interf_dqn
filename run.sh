...
python3 main.py --total-steps 5000000 --grad-norm 10 --lr 0.0001 --eval-freq 10000 --duel --double --loss-type 'Huber' --buffer-size 30000 --init-buff-size=30000 --decay-steps=10000
